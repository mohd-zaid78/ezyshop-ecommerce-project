...
<body>
	...
	<div class="top-nav">
		<a href="logout">Logout</a> <b>Cart</b> <b>${user.getUserName()}</b>
	</div>
	...
	<table class="itemtable">
		<thead>
			<tr class="itemtable-thead-tr">
				...
				<th class="itemtable-thead-th">Delete From Cart</th>
			</tr>
		</thead>
		<tbody>
			...
			<c:forEach var="it" items="${items}">
				<tr class="itemtable-tbody-tr">
					<td class="itemtable-tbody-td">${it.itemName}</td>
					<td class="itemtable-tbody-td">${it.itemBrand}</td>
					<td class="itemtable-tbody-td">${it.itemCost}</td>
					<td class="itemtable-tbody-td"><a
						href="/deletefromcart/${it.getItemId()}">Delete</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
